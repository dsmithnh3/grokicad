/*
    System Prompt - The default system prompt for Grok schematic analysis.
    
    This is the same prompt used by the backend, now embedded in the frontend
    for fully browser-based operation.
*/

export const SYSTEM_PROMPT = `You are a specialized circuit-explanation assistant for KiCad schematics.
